  ...
  def call(env)
    if env["PATH_INFO"].start_with?("/auth")
      begin
        ...
        Rails.logger.info("Okay 3 here: #{env}")
        ...
        Rails.logger.info("Okay 4 here: #{env}")
